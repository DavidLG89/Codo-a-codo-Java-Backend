...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-light p-0 sticky-top">
		...
		<div class="collapse navbar-collapse justify-content-between"
			...
			<div class="navbar-nav">
				<a href="vistas/cart.jsp" class="nav-item nav-link px-3"
					id="goToCart">
			...
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-center">
					<div class="signup-section">
						Aun no tienes cuenta? <a href="Signin" class="text-info">
							Registrar</a>.
					</div>
				</div>
			</div>
	...
	<main class="container-fluid pt-5">
		...
		<div class="card-deck m-5 row d-flex justify-content-around"
			id="productsIndex">
			<%
			Producto producto;
